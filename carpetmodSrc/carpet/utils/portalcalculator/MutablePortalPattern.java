...
{
    private final PortalSilentSearcher parentSearcher;
    ...
    public MutablePortalPattern(PortalSilentSearcher parentSearcher, BlockPos posInitial, EnumFacing.Axis axis, boolean expansive)
    {
    ...
    @ParametersAreNonnullByDefault
    public MutablePortalPattern(PortalSilentSearcher parentSearcher, BlockPos posInitial, EnumFacing.Axis axis)
    {
        this(parentSearcher, posInitial, axis, true);
    }
    ...
    public boolean isEmptyBlockAt(int x, int y, int z)
    {
        try
        {
            IBlockState blockState = parentSearcher.getBlockStateSilent(x, y, z);
